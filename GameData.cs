...
namespace OBA
{
    public class GameData
    {
        ...
        private static Action parseAction(XElement actionElement)
        {
            ...
            return new Action(text, new StatChange(stat_faith, stat_people, stat_security, stat_money),unlockEncounters:unlockEncountersList);
        }
    }
}
